...
<% 
   ...
   ArrayList<Product> drywallProducts=catalog.getDrywallProducts();
   request.setAttribute("CardboardProducts",drywallProducts);
%>
...
<div class="stroka">
	...
	<label for="height">Толщина</label>
	...
	<label for="stock">Остаток</label>
	  ...
	  <c:forEach var="product" items="${CardboardProducts}">
		  ...
		  <form method="post" action="ActionsDrywall">
			...
			<input type="number" step="any" name="height" value="${product.getOtherParameters()[2]}">
		  ...
		  <form method="post" action="DeleteProduct">
		    <input type="hidden" name="productTypeID" value="4" />
		  	<input type="hidden" name="productID" value="${product.getID()}" />
	...
	<form method="get" action="ActionsDrywall">		 
	  <div class="str2">
	  	...
	  	<input type="number" step="any" class="form-control" name="height" placeholder="Толщина"> 
