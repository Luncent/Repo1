...
<% 
   ...
   ArrayList<Product> membranaProducts=catalog.getMembranaProducts();
   request.setAttribute("CardboardProducts",membranaProducts);
%>
...
<div class="stroka">
	...
	<label for="stock">Остаток</label>
	  ...
	  <c:forEach var="product" items="${CardboardProducts}">
		  ...
		  <form method="post" action="ActionsMembrana">
			...
			<input type="number" step="any" name="weight" value="${product.getOtherParameters()[2]}">
		    ...
		    <input type="hidden" name="productTypeID" value="3" />
		  	<input type="hidden" name="productID" value="${product.getID()}" />
	...
	<form method="get" action="ActionsMembrana">		 
	  <div class="str2">
	  	...
	  	<input type="number" step="any" class="form-control" name="weight" placeholder="Вес">
